...
export default function CarsPage() {
  ...
  const handleSearch = async (e?: any) => {
    ...
    setError("")
    try {
      const res = await getCars(undefined, undefined, {
        name: name || undefined,
        vin: vin || undefined,
        ...
        >
          <button
            ...
            onClick={(e) => {
              e.stopPropagation()
              setViewer((v) =>
                v ? { images: v.images, index: (v.index - 1 + v.images.length) % v.images.length } : v
              )
            }}
          >
          ...
          <button
            ...
            onClick={(e) => {
              e.stopPropagation()
              setViewer((v) =>
                v ? { images: v.images, index: (v.index + 1) % v.images.length } : v
              )
            }}
          >
