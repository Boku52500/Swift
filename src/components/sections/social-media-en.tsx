...
export function SocialMediaSectionEn() {
  return (
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12 text-center text-neutral-400">
          ...
          <ul className="mt-4 space-y-2">
            <li>• New cars on US auctions</li>
            <li>• Special import offers</li>
            <li>• Best value used cars</li>
            <li>• Tips and news for importing cars</li>
          </ul>
        </div>
      </div>
    </section>
