...
export function BlogScrollSection() {
    ...
    <section className="py-12 bg-white">
      <div className="container mx-auto px-4">
        <div className="mb-6 text-center">
          <h2 className="text-2xl md:text-3xl font-bold">ბლოგი</h2>
          <Link href="/blog" className="text-red-600 hover:text-red-700 font-medium mt-2 inline-block">
            ნახეთ ყველა
          </Link>
        </div>
        <div
