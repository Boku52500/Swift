...
export function BlogScrollSectionEn() {
  ...
  if (!blogPostsEn?.length) return null
    ...
    <section className="py-12 bg-white">
      <div className="container mx-auto px-4">
        <div className="mb-6 text-center">
          ...
          <Link href="/en/blog" className="text-red-600 hover:text-red-700 font-medium mt-2 inline-block">
            View all
          </Link>
        </div>
        <div
