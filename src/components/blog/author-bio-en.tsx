      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <p className="text-neutral-700 text-sm mt-1">
            Experience in importing cars from the USA: auctions, logistics, customs clearance and full support. For questions: {siteConfig.contact.phone} • {siteConfig.contact.email}
          </p>
        </div>
      </div>
    </section>
